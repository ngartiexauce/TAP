...
point *generateCircles(int n, int k); // n points au hasard sur k cercles
...
// Routine de dessin et de construction de grille. Le point (0,0) de
...
// ajoute à une grille n "blobs" de type t
...
// Définit le nombre d'appel à DrawGrid par seconde (minimum 1), utile notamment
// quand vous trouvez un chemin et pour ralentir l'affichage à ce moment.
